...
<div class="sambutan container">
    <h1>WELCOME TO SMA UNggulan Berbasis Pesantren Amanatul Ummah - “Sekolahnya Para Champions”</h1>
    <p>
...
<br>
<h1 align="center">Program Tahfidzul Al-Qur'an</h1>
                    ...
                    @if (!$fileinfo->isDot())
                        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                            <div class="portfolio-wrap">
                                <img src="/Tahfidzul Qur_an/{{$fileinfo->getFilename()}}" class="img-fluid" alt="">
